...
"""
# Imports
from imports import CommandLineInterface, User, ActionsController, Input_Sanitisation_Service, Encryption_Service, Login_Service, Logger
...
def main():
    ...
    auditor = MockAuditor
    logger = Logger(log_file='logs.txt')
